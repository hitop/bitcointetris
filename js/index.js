...
var tetris = {
    ...
    initInfo: function() {
        ...
        // this.time=0;this.score=0;this.level=0;this.lines=0;
        this.setInfo('time');
        this.setInfo('score');
        this.setInfo('level');
        this.setInfo('lines');
    ...
    handleKey: function(e){
        ...
        switch (c){
            case 37:
                (this.isActive==1)?this.move('L'):null;
                break;
            case 38:
                (this.isActive==1)?this.move('RT'):null;
                break;
            case 39:
                (this.isActive==1)?this.move('R'):null;
                break;
            case 40:
                (this.isActive==1)?this.move('D'):null;
                break;
            case 32: //space
                this.togglePause();
                // tetris.init();
                break;
            case 82: // R restart 重新开始
                this.init();
                break;
            default:
                break;
...
$("#up").click(function(){tetris.move("RT")})
$("#left").click(function(){tetris.move("L")})
$("#right").click(function(){tetris.move("R")})
$("#down").click(function(){tetris.move("D")})
...
// var worker = new Worker("js/getBtcprice.js");
function getbtcp() {
    // 获取比特币价格
    var btcp = $("#btcprice")
    ...
    $.getJSON("https://blockchain.info/zh-cn/ticker", function (data) {
        btcp.html(data.CNY.last.toFixed(2));
        btcp.css("color","black")
        // console.log(data)
    });
}

var id = setInterval(getbtcp,5000);